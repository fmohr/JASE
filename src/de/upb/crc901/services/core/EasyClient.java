...
public final class EasyClient {
   ...
   *
   */
  public EasyClient withAddedMethodOperation(final String outFieldName, final String variableFieldName, final String methodName, final String... methodArgFieldNames) {
  ...
  public EasyClient withClientID(final String clientID) {
    Objects.requireNonNull(clientID);
    this.body.setClientID(clientID);
    return this;
  }
  ...
  /**
   * Sets the otms that is being used by this client. An otms object contains caches that help speedup
   * serialization after the otms is used a bunch.
   */
